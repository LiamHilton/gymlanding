...
import image1 from '../assets/offer.jpg';
import image2 from '../assets/hero1.jpg';
import image3 from '../assets/customer1.jpg';
import image4 from '../assets/customer2.jpg';
import image5 from '../assets/customer3.jpg';
import image6 from '../assets/customer4.jpg';
...
const reviews = [
  ...
  { id: 4, name: "Daniel Kim", image:image4, stars: 4, review: "The atmosphere is so calming, and the instructors are very professional. Love it here!" },
  { id: 5, name: "Olivia Brown", image:image5, stars: 5, review: "This place changed my life! I feel so much healthier and more relaxed." },
  { id: 6, name: "James Wilson", image: image6, stars: 5, review: "An incredible experience. I always leave feeling refreshed and motivated." },
];
